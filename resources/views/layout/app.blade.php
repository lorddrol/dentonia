            ...
            <div class="modal-content">
                <div class="modal-body">
                        ...
                        <div name="login" class="d-block">
                            ...
                            <button class="btn btn-outline-primary btn-form-reg" type="button" onclick="nextGuide(this, 'regform', '')">Создать
                                аккаунт</button>
                        </div>
                        ...
                        <div name="password" class="d-none">
                            <div class="d-flex justify-content-between w-100">
                                ...
                                <div><button type="button" onclick="nextGuide(this, 'login', 'block')" class="btn btn-close"
                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                            </div>
                    ...
                    <form action="{{Route('reg')}}" method="post" onsubmit="sendingForm(this, event)">
                        ...
                        <div name="regform" class="d-none">
                            <div class="d-flex justify-content-end w-100">
                                <button type="button" class="btn-close" data-bs-dismiss="modal" onclick="nextGuide(this, 'login', 'block')"
                            ...
                            <button class="btn btn-outline-primary btn-form-reg" type="button" onclick="nextGuide(this, 'login', '')">У меня уже есть
                                Аккаунт</button>
                        </div>
                        {{-- пароль --}}
                ...
                <div class="modal-footer" name="modalFooter">
                    <span class="model-agreement">Используя этот сайт, вы автоматически создаете или используете имеющуюся учетную запись на dentonia, соглашаетесь на обработку персональных данных и принимаете условия <a class="model-agreement-a" href="">Пользовательских соглашений Dentonia</a> <a class="model-agreement-a" type="button" onclick="allModelAgreement(this)">Подробнее</a><span name="hiden-modal-footer-bla-bla" class="model-agreement d-none">, <a class="model-agreement-a" href="">Политикой конфиденциальности Dentonia</a>, даете согласие на сбор и обработку данных в соответствии с ними, в т.ч. с применением cookie файлов, средств анализа поведения пользователей, с привлечением сторонних сервисов, соглашаетесь на получение рекламно-информационных материалов от Dentonia.</span></span>
                </div>
            </div>
        </div>
    </div>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container">
                <div class="d-flex flex-nowrap">
                    ...
                    <div class="d-block d-lg-none w-100" style="margin: 0 10px">
